...
// and captures, at the moment syncManifest() runs, which SN_USER the active
// profile resolves to.
export {};
...
import { refreshCommand } from "../devCommands";

jest.mock("../appUtils");
const checkScopeMock = AppUtils.checkScope as jest.MockedFunction<
  typeof AppUtils.checkScope
>;
const syncManifestMock = AppUtils.syncManifest as jest.MockedFunction<
